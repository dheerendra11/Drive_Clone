(function(){
    ...
    let divNotepad = document.querySelector("#forfile");
    ...
    divNotepad.addEventListener("click", viewNewFile);
    ...
    function viewNewFile(){
        ...
        divAppTitle.innerHTML = "New File";
        divAppTitle.setAttribute("rid", -1);
    ...
    function addFolderHTML(rname, rid, pid){
        ...
        // let spanView = divFolder.querySelector(".folder");
        let divName = divFolder.querySelector("[purpose=name]");
